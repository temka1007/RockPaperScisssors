...
function chosenSelectionDisplayer (computerSelection, playerSelection){
...
function scoreCounter(player, computer){
    if (player === 1) {
...
function game() {
    buttons.forEach((button) => {
        button.addEventListener('click', () => {
            ...
            scoreCounter(player, computer);

            chosenSelectionDisplayer(computerSelection, playerSelection);
